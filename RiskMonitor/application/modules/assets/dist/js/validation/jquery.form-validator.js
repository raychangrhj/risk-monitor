    ...
    defaultConfig: function () {
      return {
        ...
        errorMessageTemplate: {
          container: '<div class="{errorMessageClass} alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>{messages}</div>',
