...
class common_lib {
	...
	/*public function get_committee_details($des_id,$committee_id)
	{
		$committee_det = $this->ci->common_model->get_committee_detail($des_id,$committee_id);
		return $committee_det;
	}*/
	...
	/*public function update_billing_info($data,$tree_id)
	{
		$tree_id = $this->ci->common_model->update_billing_info($data,$tree_id);
		return $tree_id;
	}*/
	...
	{
		$result = $this->ci->common_model->get_designations();
		return $result;
	}
	public function get_avatar()
	{
		$result = $this->ci->common_model->get_avatar();
		return $result;
	}
