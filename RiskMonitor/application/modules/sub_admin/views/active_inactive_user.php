...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<?php } ?>
			<form role='form' method='post' action="<?php echo base_url() . $this->config->item('sub_admin_path') . 'user_type_changed/'; ?>" />
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr id="row-<?php echo $user_list[$i]->id; ?>">
									...
									<td class="right">
										<a href="<?php echo base_url() . $this->config->item('sub_admin_path') . 'set_other_profile/' . $user_list[$i]->id; ?>" class="edit_btn"><i class="fa fa-pencil-square-o"></i></a>
