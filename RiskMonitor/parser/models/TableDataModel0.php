...
class TableDataModel0{
	
	private $connect;
	private $tableName="pdf_table0";
	public $fields=array("id", "pdf_id", "intermediary_id", "EMPTY", "Accordato", "AccordatoOperativo", "Utilizzato");
	
	public function TableDataModel0(){
