...
class TableDataModel1{
	
	private $connect;
	private $tableName="pdf_table1";
	public $fields=array("id", "pdf_id", "intermediary_id", "EMPTY", "Utilizzato", "ImportoGarantito");
	
	public function TableDataModel1(){
