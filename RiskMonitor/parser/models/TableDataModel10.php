...
class TableDataModel10{
	
	private $connect;
	private $tableName="pdf_table10";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "StatoRapporto", "Importo");
	
	public function TableDataModel10(){
