...
class TableDataModel11{
	
	private $connect;
	private $tableName="pdf_table11";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "TipoAttivita", "Cedente", "StatoRapporto", "Importo");
	
	public function TableDataModel11(){
