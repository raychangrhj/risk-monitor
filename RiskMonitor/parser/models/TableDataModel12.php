...
class TableDataModel12{
	
	private $connect;
	private $tableName="pdf_table12";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "TipologiaDiFinanziamento", "DataEvento", "TipoEvento", "EventoCancellato");
	
	public function TableDataModel12(){
