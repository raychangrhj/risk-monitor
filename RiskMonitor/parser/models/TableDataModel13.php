...
class TableDataModel13{
	
	private $connect;
	private $tableName="pdf_table13";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "TipoAttivita", "Cessionario", "FenomenoCorrelato", "Importo");
	
	public function TableDataModel13(){
