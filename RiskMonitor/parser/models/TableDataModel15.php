...
class TableDataModel15{
	
	private $connect;
	private $tableName="pdf_table15";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "Divisa", "StatoRapporto", "TipoGaranzia", "Accordato", "AccordatoOperativo", "Utilizzato");
	
	public function TableDataModel15(){
