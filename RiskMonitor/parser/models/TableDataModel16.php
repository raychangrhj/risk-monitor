...
class TableDataModel16{
	
	private $connect;
	private $tableName="pdf_table16";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "DurataResidua", "Divisa", "ImportExport", "StatoRapporto", "Importo");
	
	public function TableDataModel16(){
