...
class TableDataModel3{
	
	private $connect;
	private $tableName="pdf_table3";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "DurataOriginaria", "DurataResidua", "Divisa", "ImportExport", "TipoAttivita", "StatoRapporto", "TipoGaranzia", "RuoloAffidato", "Accordato", "AccordatoOperativo", "Utilizzato", "SaldoMedio", "ImportoGarantito");
	
	public function TableDataModel3(){
