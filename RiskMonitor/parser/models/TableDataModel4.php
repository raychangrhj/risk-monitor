...
class TableDataModel4{
	
	private $connect;
	private $tableName="pdf_table4";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "Divisa", "ImportExport", "StatoRapporto", "TipoGaranzia", "RuoloAffidato", "Accordato", "AccordatoOperativo", "Utilizzato", "SaldoMedio", "ImportoGarantito");
	
	public function TableDataModel4(){
