...
class TableDataModel6{
	
	private $connect;
	private $tableName="pdf_table6";
	public $fields=array("id", "pdf_id", "intermediary_id", "Garante", "ValoreGaranzia", "ImportoGarantito");
	
	public function TableDataModel6(){
