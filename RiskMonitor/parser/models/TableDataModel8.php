...
class TableDataModel8{
	
	private $connect;
	private $tableName="pdf_table8";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "Garantito", "StatoRapporto", "TipoGaranzia", "ValoreGaranzia", "ImportoGarantito");
	
	public function TableDataModel8(){
