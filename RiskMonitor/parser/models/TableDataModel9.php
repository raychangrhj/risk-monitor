...
class TableDataModel9{
	
	private $connect;
	private $tableName="pdf_table9";
	public $fields=array("id", "pdf_id", "intermediary_id", "Categoria", "Localizzazione", "DurataResidua", "Divisa", "ImportExport", "TipoAttivita", "StatoRapporto", "TipoGaranzia", "RuoloAffidato", "Accordato", "AccordatoOperativo", "Utilizzato", "ImportoGarantito");
	
	public function TableDataModel9(){
